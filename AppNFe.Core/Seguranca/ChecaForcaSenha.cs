...
namespace AppNFe.Core.Seguranca
{
    ...
    public class ChecaForcaSenha
    {
        ...
        public bool VerificacaoSenhaSegura(string senha)
        {
            bool resultadoVerificaco = false;
            ForcaDaSenha nivelSeguranca = GetForcaDaSenha(senha);

            switch (nivelSeguranca)
            {
                case ForcaDaSenha.Inaceitavel:                    
                case ForcaDaSenha.Fraca:
                    resultadoVerificaco = false;
                    break;
                case ForcaDaSenha.Aceitavel:                    
                case ForcaDaSenha.Forte:                    
                case ForcaDaSenha.Segura:
                    resultadoVerificaco = true;
                    break;                
            }
            return resultadoVerificaco;
        }
    }
}
